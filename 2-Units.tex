...
However, \textsc{gadget}'s code units may be modified to suit the problem at hand, an thus must be specified at \code{gadfly} initialization if they differ from the defaults listed in Table \ref{code_unit_defaults}.
