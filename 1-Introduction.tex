...
This has led to the development of a robust scientific software ecosystem with packages for numerical data analysis like \code{numpy} \citep{Oliphant2006,VanderWaltColbertVaroquaux2011}, \code{scipy} (Jones et al. 2001), \code{pandas} \citep{McKinney2011}, and \code{scikit-image}; \code{matplotlib} \citep{Hunter2007}, and \code{seaborn} for plotting; \code{scikit-learn} for machine learning, and statistics and modeling packages like \code{scikits-statsmodels}, \code{pymc}, and \code{emcee} \citep{Foreman-Mackeyetal2013}.
