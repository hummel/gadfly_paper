...
In this paper we present the first public release (v0.2) of \code{gadfly}.   Section \ref{framework} describe the structure of 

Section \ref{framework} Section \ref{visualization} Section \ref{batch_processing} Section \ref{future} Section \ref{conclusions.}
