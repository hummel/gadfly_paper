...
Recently however, the scientific python community has begun to converge on the DataFrame provided by the pandas data analysis library as a common data structure for the ecosystem. 
