...
In this paper we present the first public release (v0.2) of \code{gadfly}. 
The framework design and organizational structure are outlined in Section \ref{framework} while additional capabilities including basic SPH particle rendering and parallel batch processing are described in Section \ref{capabilities}.  Plans for added functionality are outlined in Section \ref{future}, and a summary is provided in Section \ref{summary}
