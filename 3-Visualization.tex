...
W(r,h) =
     ...
     \end{cases}
\end{equation}
where $r$ is the radius and $h$ is the characteristic width of the kernel, otherwise known as the smoothing length.  The `true' physical density at any point, $\rho{\bm{r})$ is then represented by the su
