...
The SPH particle rendering algorithm included in \code{gadfly} performs this summation over two dimensions, produces a density-weighted projection; an example of such a visualization produced by gadfly is shown in Figure \ref{fig:vis}.
