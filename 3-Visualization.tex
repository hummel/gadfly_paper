...
W(r,h) =
     ...
     \end{cases}
\end{equation}
where $r$ is the radius and $h$ is the characteristic width of the kernel, otherwise known as the smoothing length.  The physical density at any point, $\rho(\bf{r})$, is then represented by the sum
\begin{equation}
