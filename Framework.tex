...
Each particle type is expected to be contained in a different group, labeled \code{PartType0, PartType1}, etc. An additional group, \code{Header}, is also expected, containing metadata for the simulation snapshot as HDF5 attributes.  
