...
\label{sec:parallel}
Many \code{gadfly} use cases require running an identical analysis on many snapshot in order to study how the system changes with time.  
...
To aid in the parallelization of such analyses, \code{gadfly} includes utilities for performing such parallel batch processing jobs by making use of python's \code{multiprocessing} module. 
